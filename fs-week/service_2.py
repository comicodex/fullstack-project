...
ASSETS_DIR = Path(
    "/home/lorenzo/Desktop/proj/fullstack-project/fs-week/assets/")
...
def load_model():
    ...
    class2idx = json.loads(Path(ASSETS_DIR / "class2idx_second_model.json").read_text())
    idx2class = {v: k for k, v in class2idx.items()}

    model.load_state_dict(torch.load(
        "/home/lorenzo/Desktop/proj/fullstack-project/fs-week/models/second_model.pth"))
