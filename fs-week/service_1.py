...
ASSETS_DIR = Path("/home/lorenzo/Desktop/proj/fullstack-project/fs-week/assets/")
...
def load_model():
    ...
    class2idx = json.loads(Path(ASSETS_DIR / "class2idx_first_model.json").read_text())
    idx2class = {v: k for k, v in class2idx.items()}

    model.load_state_dict(torch.load(
        "fs-week/models/first_model.pth"))
